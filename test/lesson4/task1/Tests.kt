...
class Tests {
    ...
    fun accumulate() {
        ...
        assertArrayEquals(
            listOf(-1000000000).toIntArray(),
            accumulate(arrayListOf(-1000000000)).toIntArray()
        )
    ...
    fun decimalFromString() {
        ...
        assertEquals(133910215, decimalFromString("2j89g5", 35))
    }
    ...
    @Tag("7")
    fun russian() {
        assertEquals("восемьсот двенадцать тысяч пятьсот девяносто", russian(812590))
